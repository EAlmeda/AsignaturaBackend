        ...
        <div class="container">
            ...
            if($sendData) {
                if(isset($_POST['languageName']) && isset($_POST['languageIso'])) {
                    $languageEdited = updateLanguage($_POST['languageId'], $_POST['languageName'], isset($_POST['languageIso']));
                }
            }
                ...
                <div class="col-12">
                    <form name="create_language" action="" method="POST">
                        <div class="mb-3">
                            ...
                            placeholder="Introduce the name of the new language" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            placeholder="Introduce the ISO code of the new language" class="form-control"
                            required value="<?php if(isset($languageObject)) echo $languageObject->getISOCode(); ?>"/>
                            <input type="hidden" name="languageId" value="<?php echo $idLanguage; ?>"/>
                        </div>
